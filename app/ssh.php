...
$command = "/home/tplinux/bin/restartpos $pos";
$ret = ssh('10.20.3.20', 'tux', 'tux', $command);
echo '<center><pre>' . $ret . '</pre></center>';
echo '<br /><center><font color="#ff0000">La caisse N° : </font><b>'.$pos.'</b><font color="#ff0000"> a était restarté avec succès.</font></center>'
?>
