...
<div id="contner">	
	<form method="POST" action="verif1.php">
		...
		<label >MAGASIN :</label><select name="mag" ><option value="ALG">ALGER</option><option value="ORN">ORAN</option></select><br /><br />	
		
		<input type="submit" value="OK" id="OkBtn" title="enregistrer"/>			
		<input type="button" value="ANNULER" id="OkBtn" title="Annuler" onclick="location.href='accueil.php'"  />
