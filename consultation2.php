...
<div id="basic_container"></div>
		...
		<form action="consu_filtre2.php" method="POST">
	...
	<table>
		<tr>
			<th>Code Article</th><th>Désignation</th><th>Qtité</th><th>Vendeur</th><th>Rayon vendeur</th><th>Acheteur</th><th>Rayon Acheteur</th><th>Type d'opération</th><th>Utilisateur</th><th>Date</th><th>Heure</th>
		</tr>
		<?php
			...
			$req = $bdd->query('SELECT Article, Design, Qtite, Vendeur,R_vendeur, Acheteur,R_acheteur, Type_Op, Utilisateur, DATE_FORMAT(Heure, \'%d/%m/%Y à %Hh%imin%ss\') AS Heure_fr, DATE_FORMAT(date, \'%d/%m/%Y à %Hh%imin%ss\') AS date_fr FROM ces_int ORDER BY date DESC ');
