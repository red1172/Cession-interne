...
$gszId='cession	PAGE_TABLE_CASSE	20190612163628';
//-----------------------------------------------------------------------
...
function& A6_BTN_Supprimer16()
{
	...
	{
		VerifieMethodeEtAppel("CTable",'TableSupprime','Clic de BTN_Supprimer (serveur PHP)',"Table",$A1_TABLE_casse);
...
<link rel="stylesheet" type="text/css" href="PAGE_Table_casse_style.css?b3e59d5d">
